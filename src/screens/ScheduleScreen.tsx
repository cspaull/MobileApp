      ...
      <Screen contentStyle={styles.choiceScreenContent} variant="dark">
        <View style={styles.choiceScreen}>
          ...
          <View style={styles.choiceHero}>
            <Image source={require('../../assets/floor.png')} style={styles.choiceLogo} />
          ...
          <View style={styles.choiceCardList}>
            <ChoiceCard
              // iconText="P"
              iconSource={require('../../assets/pencil.png')}
            ...
            <ChoiceCard
              // iconText="M"
              iconSource={require('../../assets/floor.png')}
              title="MUSEUM SUGGEST"
              ...
              {submittedRequest ? (
                <>
                  ...
                  <View style={styles.assistantRow}>
                    ...
                    <View style={styles.assistantBubble}>
                      <Text style={styles.assistantBubbleText}>{customPlan.summary}</Text>
                    </View>
                  </View>
                  ...
                  <Pressable
                    onPress={() => { setSubmittedRequest(''); setRequest(''); }}
                    style={styles.resetButton}
                  >
                    <Text style={styles.resetButtonText}>✕ Clear & Retry</Text>
                  </Pressable>
                </>
              ) : (
                <>
